...
| IR node | Turbo BASIC form | Status |
|---|---|---|
| `Dim` | `DIM name(bounds)[, ...]` | Supported, including computed BP-relative LOCAL bounds; corpus observed |
...
| `Input` | console `INPUT ...` | Supported, including INTEGER DGROUP/BP bridge variants; corpus observed |
